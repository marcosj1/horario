 ...
 <div id="crud" class="row">
 	...
 	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
 		<div class="page-header">
 			<h2 class="pageheader-title">Categoría</h2>
 				@if(session()->has('msj'))
 	...
 	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
 		<div class="card">
 			<h5 class="card-header">Lista de Categorías <a href="../categoria/create" class="btn btn-rounded btn-primary" style="width: 100px;float: right; margin-left: 10px;">+ Registar</a></h5>
 				...
 				@foreach($est as $ests)
 							<tr>
 								...
 								<td>
 									...
 									<a href="{{ route('categoria.edit',$ests->id) }}"><button href="#" class="btn btn-rounded btn-info">Modificar</button></a>
